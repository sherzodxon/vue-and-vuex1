<template>
    <div class="shadow container-xl border rounded mt-5 p-5 pb-5 border-ligth-subtle" v-if="!loading">
       ...
       <div class="email-wrapper mb-3">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="yellow" class="bi bi-envelope-at" viewBox="0 0 16 16">
